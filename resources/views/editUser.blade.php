      ...
      <a class="navbar-brand js-scroll-trigger" href="#page-top"><img src="assets/img/navbar-logo.svg" alt="" /></a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            <li class="nav-item"><a class="nav-link js-scroll-trigger" href="/manageUser">Manage</a></li>
    ...
    <section class="page-section" id="contact">
      <div class="container">
        <div class="text-center">
          ...
          <h3 class="section-subheading text-muted">My User</h3>
        </div>
        ...
        <div class="form-group">
            ...
            <div><font color="white">{{$User->email}}</font></div>
        </div>
        <div class="form-group">
            <label for="image"><font color="white">Profil</font></label>
            <input type="file" class="form-control" required="required" name="image" value="{{$User->profil}}"><br>
        </div>
        <div>
            <img width="150px" src="{{asset('storage/'.$User->profil)}}">
        </div>
        <div class="text-center">
            <div id="success"></div>
