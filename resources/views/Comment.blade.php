      ...
      <a class="navbar-brand js-scroll-trigger" href="#page-top"><img src="assets/img/navbar-logo.svg" alt="" /></a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            ...
            <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#">Comment</a></li>
    ...
    <section class="page-section" id="contact">
      <div class="container">
        <div class="text-center">
          <h2 class="section-heading text-uppercase">Ceritakan</h2>
          <h3 class="section-subheading text-muted">Pengalamanmu disini</h3>
        </div>
        <form class="php-email-form mt-4" action="/project/create" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group">
            <label for="content"><font color="white">Content</font></label>
